...
class Suite11LangChain4j extends BaseTest {
    ...
    void test_tool_extraction() {
        ...
        Map<String, Object> greetProps =
                (Map<String, Object>) greetTool.getInputSchema().get("properties");
        assertTrue(
    ...
    void test_compiles_via_server() {
        ...
        List<String> toolNames = tools.stream().map(t -> (String) t.get("name")).collect(Collectors.toList());
