...
public class UserProxyAgent {
     ...
     */
    public static Agent create(String name, String humanInputMode, String defaultResponse, String model) {
        if (!ALWAYS.equals(humanInputMode) && !TERMINATE.equals(humanInputMode) && !NEVER.equals(humanInputMode)) {
